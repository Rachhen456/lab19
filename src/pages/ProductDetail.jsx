								    ...
								    <div class="tab-pane border fade" id="pills-review" role="tabpanel" aria-labelledby="pills-review-tab">
								      <div class="row">
								   		<div class="col-md-8">
								   			...
								   			<div class="review">
										   		<div class="user-img" style={{backgroundImage: "url(images/person1.jpg)"}}></div>
										   		<div class="desc">
										   			<h4>
										   	...
										   	<div class="review">
										   		<div class="user-img" style={{backgroundImage: "url(images/person2.jpg)"}}></div>
										   		<div class="desc">
										   			<h4>
										   				<span class="text-left">Jacob Webb</span>
										   				<span class="text-right">14 March 2018</span>
										   	...
										   	<div class="review">
										   		<div class="user-img" style={{backgroundImage: "url(images/person3.jpg)"}}></div>
										   		<div class="desc">
										   			<h4>
										   				<span class="text-left">Jacob Webb</span>
										   				<span class="text-right">14 March 2018</span>
